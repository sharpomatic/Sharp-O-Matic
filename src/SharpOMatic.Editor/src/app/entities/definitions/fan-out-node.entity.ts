...
export class FanOutNodeEntity extends NodeEntity<FanOutNodeSnapshot> {
    ...
    constructor(snapshot: FanOutNodeSnapshot) {
        ...
        this.isDirty = computed(() => {
            ...
            const namesContentChanged = namesLengthChanged || currentNames.some((name, index) => name !== snapshotNames[index]);
    ...
    public addOutput(name: string): void {
        const newConnector = ConnectorEntity.fromSnapshot(ConnectorEntity.defaultSnapshot());
